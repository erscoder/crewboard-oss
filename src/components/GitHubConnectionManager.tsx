      ...
      <div className="flex items-center justify-between">
        ...
        {status?.connected ? (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-red-500/30 px-2.5 py-1.5 text-xs text-red-500 hover:bg-red-500/10 transition-colors"
          >
          ...
          <button
            onClick={() => { window.location.href = '/api/github/authorize' }}
